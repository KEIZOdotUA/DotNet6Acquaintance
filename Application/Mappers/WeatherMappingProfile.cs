...
/// <summary>
/// Application weather mapping profile.
/// </summary>
...
public class WeatherMappingProfile : Profile
{
    ...
    private readonly Dictionary<int, string> _cloudCoverDescription = new()
    {
        ...
        { 8, "81%-94%" },
        { 9, "94%-100%" },
        { Common.Www7timerBrokenIntValue, Common.Www7timerBrokenStringValue },
    };
    ...
    private readonly Dictionary<string, string> _precipitationTypeDescription = new()
    {
        ...
        { "icep", "ice pellets" },
        { "none", String.Empty },
        { Common.Www7timerBrokenStringValue, Common.Www7timerBrokenStringValue },
    };
    ...
    public WeatherMappingProfile()
    {
            ...
            .ForMember(
                ...
                opt => opt.MapFrom(
                    x => DateTime.Now.Date
                        ...
                        .ToString($"{Common.DefaultTimeFormat} {Common.DefaultDateFormat}")))
        ...
        CreateMap<CivilLightForecast, HumanizedCivilLightForecastDto>()
            .ForMember(
                ...
                .ToString($"{Common.DefaultDateFormat}")))
    ...
    /// <summary>
    /// Gets the prettified temperature.
    /// </summary>
